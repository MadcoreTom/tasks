...
export function Task(props: {task:TaskType, colour:string, idx:number, isSelected:boolean}) {
    ...
    return <g onMouseDown={onMouseDown} onMouseUp={() => dispatch(select({type:"task",idx:props.idx}))} className="clickable">
